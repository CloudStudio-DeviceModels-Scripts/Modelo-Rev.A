...
# Parsing + Configuration Script – Modelo - Rev. A

This **Parsing + Configuration** script is designed for the **Modelo** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Modelo Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Modelo** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
